    ...
    },
    {
      cell: row => (
        <button
          ...
          type="button"
          style={{ height: "30px", width: "90px", backgroundColor: "#3FA2F6", color: "#fff", border: "none", borderRadius: ".8rem", cursor: "pointer", boxShadow: "3px 3px 5px rgba(0, 0, 0, .31)", fontSize: "15px" }}
