...
export default function B2GComparePage() {
  return (
    <div className="image" style={{ height: "1200px" }}>
      <div>
        <h1 className="text-dark fs-1 fw-bold text-decoration-underline font-monospace mx-2">
          <b>
            Compare Your Medicines With MedGen Alternatives & Estimate Savings
          </b>
        </h1>
      </div>
          ...
          <div className="cards">
            <div class="row ">
              <div class="col-sm-6 mb-4 mb-sm-0  ">
                <div
                  class="card border-4 border-dark shadow-lg"
                  style={{ backgroundColor: "#e6ffff" }}
                >
                  <div
                    class="card-body card-1 border-4 border-dark shadow-lg"
                    style={{ backgroundColor: "#e6ffff" }}
                  >
              ...
              <div class="col-sm-6 mb-4 mb-sm-0 ml-5">
                ...
                >
                  <div
                    class="card-body card-2 border-4 border-dark shadow-lg"
                    style={{ backgroundColor: "#e6ffff" }}
                  >
                    <div className="card-write">
                      <h5 class="card-title fs-3 fw-bold">
      ...
      <div>
        <div
          className="width-50 text-dark"
          style={{ marginLeft: "575px", marginTop: "100px" }}
        >
          <div
            class="price-comparison border-3 border-dark shadow-lg font-monospace"
            style={{ backgroundColor: "#e6ffff" }}
          >
