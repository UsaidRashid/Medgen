...
const RegistrationForm = () => {
  ...
  const handleSubmit = async (e) => {
    try {
      ...
      const response = await axios.post(
        process.env.REACT_APP_BACKEND_URL + "/medilo/request-medicine",
        formData
      );
  ...
  return (
    <div>
      ...
      >
        <h1
          className="text-white text-center fw-bold p-5"
          style={{ fontSize: "55px" }}
        >
          Get In<b style={{ color: "#00bbf0" }}> Touch</b>{" "}
        </h1>
        <img
          src={upperImage}
      ...
      <div style={{ backgroundColor: "white" }}>
        <h1 className="text-center mb-5 text-dark" style={{ fontSize: "50px" }}>
          Join our <b style={{ color: "#004080" }}>MEDGEN </b>Family !
        </h1>
        <div
          className="formSection mx-5 border border-dark p-5"
          style={{
            boxShadow: "0 -5px 10px #232424",
            borderRadius: "50px",
        ...
        >
          <Form className="mx-5" onSubmit={handleSubmit}>
            ...
            <div class="my-5">
              <textarea
                className="form-control 'border border-3 rounded-3'"
      ...
      >
        ...
        <div
          className="position-absolute"
          style={{ marginTop: "700px", marginLeft: "500px" }}
        >
