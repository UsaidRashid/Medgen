  ...
  return (
    ...
    >
      ...
      {medicine.alternatives.map((alternative) => (
        <div
          className="d-flex align-items-center my-3 mx-5"
          key={alternative.name}
        >
          <div
            className="card flex-grow-1 d-flex align-items-center justify-content-center p-3 text-center shadow-sm mx-3"
